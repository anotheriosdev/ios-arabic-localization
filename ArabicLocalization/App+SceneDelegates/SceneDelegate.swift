...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(languageUpdated), name: NSNotification.Name("ChangeAppLanguage"), object: nil)
        languageUpdated()
    }

    @objc func languageUpdated(){
        ...
        if (Defaults.language ?? "") == "en"{
            ...
            UIDatePicker.appearance().locale = Locale(identifier: "en_US_POSIX")
        } else{
